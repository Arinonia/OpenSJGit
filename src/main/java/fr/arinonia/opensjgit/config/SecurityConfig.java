package fr.arinonia.opensjgit.config;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(final HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeRequests(authorise -> authorise.requestMatchers("/register", "/login", "/css/**", "/images/**", "/js/**").permitAll()//TODO @Deprecied have to look how to replace that
